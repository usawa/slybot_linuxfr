dictons = ["L'année bissextile soyez fin, semez du chanvre au lieu du lin",
"En l'année bissextile, garde du blé pour l'an qui suit",
"Limaçon aventureux, le temps sera pluvieux",
"S'il gèle à la Saint-Raymond, l'hiver est encore long",
"Quand il pleut à la Saint-Servais, pour le blé, signe mauvais",
"Temps clair et doux au Nouvel-An, assure le beau temps tout l'an",
"Un mauvais an entre en nageant, mais s'il gèle, l'année sera belle",
"Le vent dominant au jour de l'An, soufflera sur la moitié de l'an",
"Calme et claire nuit de l'An, à une bonne année donne élan",
...
"Moins on ment, mieux on se sent",
...
"Année de sécheresse, à toujours fait richesse",
"Prunes et melon mettent la fièvre à la maison",
...
"Si les poissons sautent dans l'eau, La pluie est pour bientôt",
"Bon écorcheur choisit la peau",
"Papillon blanc, Annonce le printemps",
"Orage du matin, Ruine le vilain",
"Toutes les fois qu'il tonne, la foudre ne tombe pas",
"Oignons bien habillés, Annoncent fortes gelées",
...
"Lune d'argent, C'est le beau temps., Lune blanche, Journée",
"franche;, Lune pâle, L'eau dévale;, Lune rouge, Le vent bouge",
...
"Mai froid et chaud juin, Donnent pain et blé",
"Le jour de la Saint-Maximin, S'embaume de jasmin.",
...
"Porcelet d'un mois, oison de trois, Est manger de princes et de rois.",
"Année neigeuse, Année _f_r_o_m_e_n_t_e_u_s_e",
"Bien servir fait amis, Et vrai dire ennemis.",
"Qui aime l'arbre aime la branche.",
"Si l'hiver est surchargé d'eau, L'été en sera que plus beau.",
"Dindon perché, Temps moullé.",
"Du dimanche matin la pluie, Souvent la semaine ennuie.",
"Si l'hiver ne fait son devoir, En mois de décembre ou de janvier, Au plus tard il se fera voir, Dès le deuxième février."
"Homicide, mensonge et larcin, Se découvrent toujours à la fin.",
"Chant du coucou, Temps doux.",
"Si le coq chante le soir, C'est signe qu'il va pleuvoir.",
"Si le coq boit en été, bientôt il pleut.",
"A Mardi gras qui n'a pas de viande tue son coq, Qui n'a pas de coq tue sa femme.",
"C'est chose qui moult déplaît, Quand poule chante et coq se tait.",
"Le coq et le serviteur, Un seul an sont en vigueur.",
"La lame use le fourreau.",
"A la Saint-Martin, Tue ton cochon et invite tes voisins.",
"Ciel bleu foncé, Vent renforcé.",
"Ciel moutonné, Beau temps passé.",
"Ciel rouge le soir, blanc le matin, Ravi le pèlerin.",
"Quand chat se frotte la tête, Il y aura bientôt tempête.",
"Chat se chauffant, Est signe de mauvais temps.",
"Année de glands, Année d'enfants.",
"Année de glands, Année d'argent.",
...
"A la Sainte-Eugénie, Toute semaille est finie.",
...
"A la Sainte-Justine, Toute les fleurs s'inclinent.",
"Quand il pleut le jour de Notre-Dame, Il pleut jusqu'au 8 septembre.",
"A la Saint-Thibaut, Sème tes raves, arrache tes aulx.",
"Eau de Saint-Jean, Peu de vin et peu de grain.",
...
"A la fête de la Chandeleur, Les jours croissent de plus d'une heure",
"Beaucoup d'étoiles pour la nuits des Rois, Et sécheresse en été tu auras.",
"S'il pleut à la Saint-Médard, C'est du beau temps pour les canards.",
"Canard qui crie, Et c'est la pluie.",
"En petit champ croit bien blé.",
"Si tu veux des blés, Fais des prés.",
"Année de gelée, Année de blé.",
"Bon champ semé, Bon blé rapporte",
"De tout bois on fait feu.",
"Bon berger tond, mais n'écorche pas.",
"Sauts de baleine, Grosse bise prochaine. Mais sauts plus hauts, Tempête au plus haut.",
"Le baiser est un fruit qu'il faut cueillir sur l'arbre.",
"La pluie d'avril remplit les greniers.",
"Fleur d'avril, Tien par un fil.",
"Le mois d'avril est cousu de mauvais fil.",
"N'attends jamais d'autrui ce que tu peux toi-même faire.",
"Qui se tient aux écoutes entend souvent son fait.",
"Astrologue parle bien d'avenir, Mais il ne le fait pas venir.",
"Dans l'argile sable vaut fumier.",
"Argent fait rage, Et amour mariage.",
"L'Arc-en-ciel du soir, Fait le beau temps paroir.",
"Pain dérobé reveille l'appétit.",
"Chante à ton baudet, il te fera un pet.",
"C'est folie de faire boire un âne s'il n'a pas soif.",
"Ane avec le cheval ne doit s'atteler.",
...
"Aimer est bon, mieux est être aimé, L'un est servir et l'autre dominer.",
"Amours nouvelles, Oublient les vieilles.",
"L'amour apprend aux ânes à danser.",
"Aimer n'est pas sans amer.",
"Heure de nuit, heure de jour, sont toujours bonne en amour.",
"Il n'y a point de laides amours. L'objet qu'on aime est toujours beau.",
...
"Au poulailler sont les fouines.",
...
"Si tu aime le miel, ne crains pas les abeilles.",
...
"Plus le bouc sent, plus la chèvre l'aime.",
"Mi-janvier, Mi-paille.",
"Le laboureur se réjouit, S'il pleut à la Saint-Denis, Tout l'hiver sera pluie.",
"S'il pleut le jour de la Saint-Denis, Tout l'hiver aurez de la pluie.",
"Lorsqu'il tonne à la Sainte-Cunégonde, Il faut encore porter des gants."
"Passé la Saint-_Clément, Ne sème plus de froment.",
"Si le jour de Sainte-Claire, La journée est chaude et claire, Comptez sur les fruits à couteau, A coup sûr ils seront beaux.",
"A la Sainte-Cécile, Chaque fève en fait mille.",
...
"Soleil du jour de Saint-_A_n_a_t_o_l_e, Pour la moisson joue un grand rôle.",
"Si Sainte-Agathe emplit les rivières, Le lait coulera dans les chaumières.",
"A Saint-Antoine grande froidure, A Saint-_L_a_u_r_e_n_t grands chauds ne durent.",
...
"S'il pleut pour la Sainte-_A_n_n_e, Il pleut un mois et une semaine.",
...
"Serein en hiver, pluie en été, Ne font pas grande pauvreté.",
...
"A la Saint-_S_é_v_e_r_i_n, La neige est en chemin.",
...
"Lorsque Saint-Eloi a bien froid, Quatre mois dure le plus grand froid.",
"La pluie de juin, Fait belle avoine et maigre foin.",
"Mai mois de fleurs, mois de pleurs.",
"Mai, mois fleuri, mois béni.",
"S'il pleut le jour de Sainte-Pétronille, Elle est quarante jours à Erbinet, Le pire de tous quand il s'y met, Car il casse le robinet.",
...
Quand, au printemps, La lune est claire, Peu de noix espère, Si
la lune est trouble, La noix redouble.
La vigne me dit:, En mars me lie, En mars me taille, En mars, il
faut qu'on me travaille!.
...
En mars, les vaches au pré, Si ce n'est pour manger, C'est pour
s'y gratter.
Le jour de la Sainte-Félicité, Se voit venir avec gaieté., Car, on
l'a toujours remarqué, C'est le plus beau jour de l'année.
...
Grands vents du nord en février, Annoncent la fertilité. -
Au mois de février, Chaque herbe fait son pied.
A la Saint-Florent, Il est bien de semer le froment, Mais sans
perdre de temps.
Si février n'a pas de grands froids, Le vent dominera tous les
autres mois.
...
A la Sainte-Barnadette, Souvent le soleil est de la fête.
...
En février, si au soleil ton chat tend sa peau, En mars, il
l'exposera au fourneau.
A la Sainte-Apolline, présage certain, L'hiver s'achemine, ou
touche à sa fin.
Eté de la Saint-Jean, Quelques jours cléments.
Si février est chaud, Croyez bien, sans défaut, Que par cette
aventure, Pâques aura sa froidure.
Si pour la Sainte-Agathe il pleut, Le maïs croit au mieux.
Au cinq de la lune tu jugeras, Quel temps tu auras tout le mois.
Le lendemain de Saint-Blaise, Souvent l'hiver s'apaise, Mais si
vigueur il reprend, Pour longtemps on s'en ressent.
...
Quand il fait beau à la Saint-Vincent, Le vigneron est toujours
content.
...
Verdure en janvier, Eté fera pitié.
...
Si le soir du jour des Rois, Beaucoup d'étoiles tu vois, Auras
...
A Sainte-Colombe, Le ramier quitte sa colombe.
A la Saint-Thomas, Cuit ton pain, lave tes draps:, Dans trois
jours Noël t'auras.
S'il neige à la Sainte-Eléonore, Les récoltes seront d'or.
Les douze jours qui vont de Noël aux Rois, Donnent le temps des
douze mois.
Noël au balcon, Pâques au tison.
Beau temps à Sainte-_A_d_è_l_e, Est un cadeau du ciel.
A Saint-_E_v_a_r_i_s_t_e, Jour de pluie, jour triste.
...
A la Saint-_G_a_t_i_e_n, Le temps ne vaut rien.
Quand il pleut à la Sainte-_A_l_i_c_e, C'est souvent comme une vache qui
pisse.
La neige des Avents, A de longues dents.
A la Saint-_E_u_s_è_b_e, Au plus tard, fais battre la gerbe.
Au moment où commence avril, L'esprit doit se montrer subtil.
Jour de l'an beau, Mois d'août très chaud
Visite les ruches à la Saint-_D_a_n_i_e_l, Mais garde-toi d'ôter le miel.
Veux-tu oignons, carottes, seigle, petits pois, Sème-les à la
S'il tonne au jour de Saint-_P_a_s_c_a_l, Sans grêle, ce n'est pas un
mal.
Temps trop beau en août, Annonce un hiver en courroux.
Temps clair à la Sainte-_V_i_v_i_a_n_e, Temps clair pendant quarante jours
et une semaine.
Taillis pluvieux à la Saint-_S_y_l_v_a_i_n, Fait tout l'an incertain.
A la Saint-_B_e_n_j_a_m_i_n, Le mauvais temps prend fin.
Souvent à la Saint-Florent_i_n, L'hiver lisse le chemin.
...
Soleil de Sainte-_N_i_n_a, Pour un long hiver rentre ton bois.
Soleil de Saint-_P_r_i_e_s_t, Abondance de millet.
Si tu as vu Saint-_C_h_r_i_s_t_o_p_h_e, Tu ne crains aucune _c_a_t_a_s_t_r_o_p_h_e.
Si Saint-_J_a_c_q_u_e_s l'apôtre pleure, Bien peu de glands il demeure.
Si les quatre premiers jours d'avril sont venteux, Il y en aura pour
quarante jours.
Si les fourmis s'agitent à la Sainte-_A_n_n_e, L'orage descend de la
montagne.
Si février laisse les fossés pleins, Les greniers seront pleins.
Si elle gèle, Sainte-_Q_u_i_t_è_r_e emporte tout dans son grand tablier.
Si décembre et janvier ne font leur chemin, Février fait le lutin.
Si à la Saint-Eloi tu brûles ton bois, Tu auras froid pendant trois
mois.
Septembre en sa tournure, De mars fait la figure.
Semé à la Sainte-_F_r_a_n_ç_o_i_s_e, Ton grain aura du poids.
premier de l'an.
Saint-Clet ferme la porte aux derniers pois.
Un pré est vaurien, Quand en juin il donne rien.
rage.
l'embrasse.
S'il vente bien fort à la Saint-_S_i_x_t_e, Le bois sera cher.
S'il pleut le jour de Sainte-_R_a_d_e_g_o_n_d_e, Misère abonde sur le monde.
S'il pleut le jour de Sainte-Pétronille, Le blé diminue jusqu'à la
faucille.
S'il pleut le jour de Saint-Victorien, Tu peux sûrement compter sur
du bon foin.
...
durant.
S'il pleut à la Saint-_F_r_a_n_ç_o_i_s_-_R_é_g_i_s, Le vin diminue jusqu'à la
lie.
S'il pleut à l'_A_n_n_o_n_c_i_a_t_i_o_n, Pluie en août à foison.
S'il neige à la Saint-Hilaire, Il fera froid tout l'hiver.
S'il ne fait froid le jour d'Adam et Eve, Vingt jours trop tôt
montera la sève.
S'il gèle au jour des quarante martyrs, Il gèlera encore quarante
jours au pire.
S'il gèle à Saint-_S_u_l_p_i_c_e, Le printemps sera propice.
S'il gèle à la Saint-_R_a_y_m_o_n_d, L'hiver est encore plus long.
S'il fait beau à la Saint-Guillaume, Auras du blé plus que de
chaume.
S'il fait beau à la Saint-Gilles, Cela durera jusqu'à la Saint-
S'il fait beau à la petite Saint-Jean, Année fructueuse en froment.
Rosée du jour de Saint-_S_a_v_i_n, Est, dit-on, rosée de vin.
...
Qui n'a pas semé à la Sainte-Croix, Au lieu d'un grain en mettra
trois.
Quand vient la Saint-Matthieu, L'été, adieu.
Quand Simon et Jude sont arrivés, Souvent ils portent la neige à
leurs souliers.
Quand Saint-Ambroise voit neiger, De dix-huit jours de froid,
danger.
Quand mars bien mouillé sera, Beaucoup de fruits cueilleras.
Quand il tonne hors saison, Pluie ou neige sans raison.
Quand il pleut à la Saint-Philippe, Le pauvre n'a pas besoin du
riche.
Quand il gèle en novembre, Adieu l'herbe tendre.
Quand il fait doux à la Saint-Patrice, De leurs trous sortent les
Quand février commence en lion, Il finit en mouton.
Quand en novembre, la pluie noie la terre, Ce sera du bien pour
tout l'hiver.
Quand au ciel Sainte-Catherine fait la moue, Il faut longtemps
...
Quand à Saint-Raoul, le soleil brille, C'est le _m_o_i_s_s_o_n_n_e_u_r qui
grille.
...
Pluie de septembre travaille, A la vigne et à semailles.
Pluie le jour de Sainte-_O_p_p_o_r_t_u_n_e, Ni cerises, ni prunes.
Pluie de Sainte-_M_a_h_a_u_d, N'est jamais trop.
Pluie de Saint-Léonce, Pour trente jours s'annonce.
Pluie de Saint-Jean noie les noisettes, Mais beau temps de Saint-
Pluie de Saint-_H_u_g_u_e_s à Sainte-_S_o_p_h_i_e, Remplit granges et fournils.
Pluie de Saint-Guy, C'est tout l'an qui rit.
Pluie de Saint-Aurélien, Belle avoine et mauvais foin.
Pluie d'orage à la Saint-Sylvère, C'est beaucoup de vin dans le
verre.
...
Orages de septembre, Neiges en décembre.
Noël grelottant, Pâques éclatant.
Neige en mars vaut blé en sac.
Neige de Saint-André, Peut cent jours durer.
Neige à Sainte-_P_r_i_s_c_a, Va apporter une belle année que voilà.
Ne crains pas du mauvais temps de Sainte-Marthe, Vite, il faut
qu'il parte.
N'aie nulle peur de l'année bissextile mais de celle d'avant et de
celle d'après.
Mois d'août pluvieux, Rend le cep vineux.
Mieux vaut chèvre que vache à lait, Quand la bonne Dame de Carmel
est arrivée.
Mars venteux, Verger pommeux.
Mars est comme la romance, Il finit comme il commence.
Mai frileux: an langoureux., Mai fleuri: an réjoui., Mai venteux:
an douteux.
Mai fait ou défait.
Lune d'avril, Ne passe pas sans gelée.
Lorsque mai est trop jardinier, Cela ne remplit pas le grenier.
Lorsque beaucoup d'étoiles filent en septembre, Les tonneaux sont
trop petits en novembre.
Lorsqu'il pleut à la Saint-_D_o_n_a_t_i_e_n, C'est de la pluie pour le mois
qui vient.
Lorsqu'en juin on voit sa fin, Saint-_M_a_r_t_i_a_l souvent lave le
chemin.
Lorsqu'arrive la Saint-_V_a_l_é_r_i_e_n, L'arbre bourgeonne et les fruits
ne sont plus loin.
Les froids de Saint-_E_v_r_o_u_l_t, Sont des froids de loup.
...
Juillet ne s'est jamais passé sans voir du blé nouveau mis en sac.
Jour de Sainte-Apolline renfrogné, C'est trois beaux mois d'été -
Qu'elle nous a gardés.
Jour de l'Immaculée, Ne se passe jamais sans gelée.
Jamais d'août la sécheresse, N'amène la richesse.
Il n'est de février si mauvais et si méchant, Qui ne nous donne huit
jours de printemps.
Il est trop tard à la Saint-_P_é_p_i_n, Pour planter les arbres à pépins.
Huit jours de neige, c'est fumure, Huit jours au-delà, c'est
poison.
Gelée du jour de Sainte-Honorine, Rend toute la vallée chagrine.
Gelée blanche pour Saint-Eustache, Grossit le raisin qui tâche.
...
En septembre, si trois jours il tonne, C'est un nouveau bail pour
l'automne.
...
De Sainte-_P_h_a_r_a_i_l_d_e la chaleur, C'est la colère et notre malheur.
De la Sainte-Agnès la douceur, Ne nous fait pas croire que l'hiver
meurt.
...
Censiers, si vous voulez m'en croire, Tondez vos moutons à la
C'est vers la Saint-Hippolyte, Que le raisin change plus vite.
C'est à la Saint-Antonin, Que vend son vin le malin.
Bon fermier, à Sainte-Juliette, Doit vendre ses poulettes.
Bise et grand vent de Saint-Armand, Font mal au froment.
Belle Euphrasie, Met pommes à l'airie.
Beaucoup de belettes blanches pour Saint-_Symphorien, Disent que
...
Avant Saint-Servais, point d'été, Après Saint-Servais, plus de
gelée.
Avant la Bonne-Dame, tu peux labourer quand tu veux, Après la
Bonne-Dame, tu laboures quand tu peux.
Autant d'heures de soleil à la Toussaint, Autant de semaines à
souffler dans tes mains.
Au vingt de Noël les jours rallongent d'un pas d'hirondelle.
Au sept d'avril, Après le coucou, C'est le rossignol qui chante.
Au mois de mai il faudrait, Qu'il ne plût jamais.
Au jour de Saint-_P_r_u_d_e_n_c_e, S'il fait du vent, les moutons dansent.
Au jour de Saint-_I_g_n_a_c_e, Moissonne quelque temps qu'il fasse.
Au jour de la Sainte-_C_o_l_e_t_t_e, Commence à chanter l'alouette.
Au jour de la Saint-_B_o_r_i_s, par malheur, C'est un mauvais
vendangeur.
Au 15 août, le coucou perd son chant, C'est la caille qui le
reprend.
Attention, le premier des saints de glace, Souvent tu en gardes la
trace.
Arcade et Hilaire gèlent les rivières.
Après Sainte-_A_n_g_è_l_e, Le jardinier ne craint plus le gel.
Après Saint-Roch, Aiguise ton soc!
Août tarit les fonts, Ou emporte les ponts.
A Sainte-Zoé, Jeunes oies.
A Sainte-_P_h_i_l_o_m_è_n_e, Misère dans les garennes.
A Sainte-_J_u_l_i_e, Le soleil ne quitte pas son lit.
A Sainte-Félicité, C'est le plein coeur de l'été.
A Sainte-_E_m_i_l_i_e, Luzerne à pleine faucille.
La nuit de Saint-Jean, Est la plus courte de l'an.
A Sainte-_T_h_é_o_d_o_r_e, Fleurit chaque bouton d'or.
A Saint-_S_o_s_t_h_è_n_e, Les poules sur le chemin ne trouvent plus de
graines.
A Saint-_R_u_f_i_n, Cerises à plein jardin.
A Saint-_L_u_d_o_v_i_c, Tes choux repique.
A Sainte-_L_é_o_n_i_d_e, Chaque blé pousse rapide.
A Saint-_J_u_s_t_i_n, Est à graines le plantin.
...
A mi-mars, Le coucou est dans la pariétaire.
A mi-février, La merlette doit couver.
A la Sainte-_M_é_l_a_n_i_e, De la pluie n'en veux mie.
A la Sainte-_V_i_r_g_i_n_i_e, La récolte de fraises est finie.
A la Sainte-_V_é_r_o_n_i_q_u_e, Le soleil à l'hiver fait la nique.
A la Sainte-_T_h_é_o_d_o_s_i_e, La rose est la fleur choisie.
A la Sainte-_S_u_z_a_n_n_e, Veau bien venu qui tête.
A la Sainte-_M_a_r_i_e, Toutes les aubépines sont fleuries.
...
A la Sainte-_D_o_r_o_t_h_é_e, La plus forte neigée.
A la Sainte-Denise, Finie la bise.
A la Sainte-_D_e_l_p_h_i_n_e, Mets ton manteau à pèlerine.
A la Sainte-Croix, Cueille tes pommes et gaule tes noix.
A la Sainte-_C_l_o_t_i_l_d_e, De fleur en buisson, Abeille butine à
foison.
A la Sainte-_C_l_é_m_e_n_c_e, les moutons prennent du ton.
A la Sainte-_C_l_a_i_r_e, s'il éclaire et tonne, C'est l'annonce d'un bel
automne.
A la Sainte-_C_h_r_i_s_t_i_n_e, Mûrit l'aubépine.
A la Sainte-_B_a_r_b_e, Soleil peu arde.
A la Saint-_T_h_u_r_i_a_u, sème les navets.
A la Saint-_T_h_i_e_r_r_y, Aux champs jour et nuit.
A la Saint-_T_a_n_g_u_y, Jamais vent ne languit.
A la Saint-_R_o_b_e_r_t, Tout arbre est vert.
A la Saint-_Q_u_e_n_t_i_n, La chaleur a sa fin.
A la Saint-_P_r_i_v_a_t, La noisette est dans les fossés.
A la Saint-_P_o_t_h_i_n, Bonhomme, sème ton sarrasin.
A la Saint-Pierre, coq chantant, Est présage de mauvais temps.
A la Saint-Pierre, S'épanouit le lierre.
A la Saint-_O_n_é_s_i_p_h_o_r_e, La sève s'endort.
...
A la Saint-_J_a_n_v_i_e_r, Les _c_h_r_y_s_a_n_t_h_è_m_e_s repoussent du pied.
A la Saint-_H_u_b_e_r_t, Les oies sauvages fuient l'hiver.
A la Saint-_H_i_l_d_e_v_e_r_t, Est mort tout arbre qui n'est pas vert.
A la Saint-_G_u_é_n_o_l_é, Au taureau ferme le pré.
A la Saint-Gontran, si la _t_e_m_p_é_r_a_t_u_r_e est belle, Arrivent les
premières _h_i_r_o_n_d_e_l_l_e_s.
A la Saint-_G_é_r_a_r_d, La récolte est encore au hasard.
A la Saint-_G_a_s_t_o_n, Trie la semense, enlève le bourgeon.
A la Saint-_F_r_é_d_é_r_i_c, tout est vert, tout est nids, Plantes, bêtes
et gens, tous sourient.
A la Saint-_F_o_r_t_u_n_é, Grande _h_a_n_n_e_t_o_n_n_é_e.
A la Saint-_F_i_r_m_i_n, Les blés battent au vent.
A la Saint-_F_a_b_i_e_n, Bon foin jaunit bien.
A la Saint-_E_u_s_è_b_e, Ponte de poule est faible.
A la Saint-_E_t_i_e_n_n_e, Les jours croissent d'une aiguillée de laine.
A la Saint-_E_t_i_e_n_n_e, Chacun trouve la sienne.
A la Saint-_D_o_m_i_n_i_q_u_e, Te plains pas si le soleil pique.
A la Saint-_C_o_r_e_n_t_i_n, Le plein hiver glace le chemin.
A la Saint-_C_é_s_a_i_r_e, La dernière forte chaleur en l'air.
A la Saint-_A_u_g_u_s_t_i_n, Le soleil a grillé le serpolet et le thym.
A la Saint-_A_r_s_è_n_e, Mets au sec tes graines.
A la Saint-_A_m_a_n_d, Sont mûrs les glands.
A la Saint-_A_l_e_x_i_s, Foin occis.
A la Saint-_A_l_e_x_a_n_d_r_e, Finies les cendres.
A Saint-Aimé, Point de moutons affamés.
A la Saint-Abel, Faites vos confitures de mirabelles.
A la Saint-Vincent, Les glaçons perdent leurs dents, Ou les
recouvrent pour longtemps.
A la Saint-_S_é_b_a_s_t_i_e_n, l'hiver reprend, Ou se casse les dents.
A la Saint-Paul s'_e_n_t_r_e_b_a_t_t_e_n_t les vents., Celui qui l'emporte
dominera l'an.
A la Saint-_J_a_c_o_b, dans nos pays, Les pies commencent leurs nids.
A la Saint-_G_e_r_l_a_c le temps froid et serein, L'année sera bonne et
fertile, c'est certain.
A la _m_i_-_n_o_v_e_m_b_r_e passée, Il peut venter et neiger à souhait.
Temps couvert à la Saint-_G_e_o_f_f_r_o_y, Amène trois jours de froid.
Novembre chaud au début, froid à la fin.
Quand en novembre tu entends la grive chanter, Rentre à la maison
pour t'abriter, Et du bois pour te chauffer.
A la Saint-_E_r_n_e_s_t, Abats les pommes qui te restent.
S'il neige à la Saint-_Z_a_c_h_a_r_i_e, Le paysan rit.
Novembre est le mois des morts, Si tu ne veux pas mourir encore, -
Si octobre s'emplit de vents, Du froid tu pâtiras longtemps.
Octobre au coin du feu, fait venir le loup.
A la Sainte-Antoine_t_t_e, La neige s'apprête.
A la Saint-_S_é_v_e_r_i_n, Chauffe tes reins.
A la Saint-_V_a_l_l_i_e_r, Faut qu'il y ait du bois au bûcher.
A la Sainte-_U_r_s_u_l_e, le temps, Parfois est un petit printemps.
Octobre glacé, Fait vermine trépasser.
Gelée d'octobre, Rend le vigneron sobre.
A la Saint-Luc, Ne sème plus, Ou sème dru.
Quand de Saint-_P_a_t_e_r_n_e vient la saison, La chaleur vient pour de
bon.
Quand de Saint-Gall arrive l'heure, La vache à l'étable demeure.
Souvent Sainte-_T_h_é_r_è_s_e nous apporte un petit été, Mais surtout,
jardinier, ne va pas te _d_é_s_h_a_b_i_l_l_e_r.
Temps sec à la Saint-_G_h_i_s_l_a_i_n, Nous annonce un hiver d'eau plein.
Beau temps à la Saint-_D_e_n_i_s, L'hiver sera bientôt fini.
En octobre qui ne fume rien, Ne récolte rien.
A la Saint-_S_e_r_g_e, La charrue en terre, Pour niveler les
A la Saint-_B_r_u_n_o, Les feuilles tombent dans le bô.
Quand arrive la Sainte-_F_l_e_u_r, Pour aller au verger, ce n'est plus
l'heure.
A la Saint-_F_r_a_n_ç_o_i_s, Vient le premier froid.
Si octobre est trop chaud, En février, la glace est au carreau.
A la Saint-_C_a_l_i_x_t_e, Il n'y a plus de fleur à calice.
Souvent à la Saint-_L_a_z_a_r_e, le froid gagne, Ou file vers la montagne.
Souvent à la Saint-_G_é_r_a_u_d, Nous arrive trois jours de beau.
Octobre est bon, S'il est de saison.
Si la Saint-_G_o_m_e_r arrive par temps sec, L'hiver sera humide dès le
A la Saint-_L_é_g_e_r, Faut se purger.
A la Saint-Rémy, De semer on doit avoir fini.
A la Saint-_J_é_r_ô_m_e, garçon, Il faut prendre de ta charrue des
manchons.
Forte chaleur en septembre, A pluie d'octobre, il faut s'attendre.
Servez Saint-Côme et Saint-_D_a_m_i_e_n, Vous vous porterez toujours
bien.
La rosée de Saint-_A_l_b_i_n, Est, dit-on, rosée de vin.
Septembre humide, Pas de tonneaux vides.
A Saint-_G_o_b_a_i_n, le bois prend feuilles, La futaie pousse à vue
d'oeil.
A Saint-Félicie_n, Mouche à miel n'a plus de bien.
A Saint-_A_u_n_e_u_i_l, Cueille les _c_o_r_n_o_u_i_l_l_e_s.
A Saint-_A_p_o_l_l_i_n_a_i_r_e, Dernière semaille de laitue en pleine terre.
A Saint-Anselme, Dernières fleurs sème.
A Saint-_A_b_d_o_n, Mûrs sont les melons.
A la Sainte-_H_y_a_c_i_n_t_h_e, On peut semer sans crainte.
A la Sainte-_L_u_c_e, Les jours croissent du saut d'une puce.
En avril, Ne te découvre pas d'un fil, En mai, Fais ce qu'il te
plaît!
A la Saint-_C_r_é_p_i_n, Les mouches voient leur fin.
...
Le jour de la Saint-_P_r_o_s_p_e_r, N'oublie pas de fumer la terre.
Temps de la Saint-_F_e_r_n_a_n_d, Chaleur et soleil riant.
Le jour de la Saint-_I_r_é_n_é_e, C'est l'un des plus beaux de l'année.
Quand Saint-Pierre laisse de la pluie à Saint-_M_a_r_t_i_a_l, Saint-
Au mois de février, Chaque bête cherche son pareil.
Dure l'hiver jusqu'à ce que fleurisse le saule.
A Sainte-_J_u_s_t_i_n_e, Toute fleur s'incline.
A la Saint-_G_é_r_a_r_d, Les noix sont mûres pour toi et pour moi.
